package com.example.user.lab7_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        standardWeight=(TextView) findViewById(R.id.standerWeight);
        ...
        new AsyncTask<Void, Integer, Boolean>(){
            ...
            @Override
                    protected void onPostExecute(Boolean status){
                        ...
                        double cal_StandarWeight=0;
                        double cal_BodyFat=0;
                        if(gender ==1){
                            cal_StandarWeight=22*cal_Tall/100*cal_Tall/100;
                            cal_BodyFat=(cal_Weight-(0.88*cal_StandarWeight))/cal_Weight*100;

                        }
                        if (gender==2){
                            cal_StandarWeight=22*cal_Tall/100*cal_Tall/100;
                            cal_BodyFat=(cal_Weight-(0.82*cal_StandarWeight))/cal_Weight*100;
                        }
                        standardWeight.setText(String.format("%.2f",cal_StandarWeight));
